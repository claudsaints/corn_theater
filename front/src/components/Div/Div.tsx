...
export const Div = styled.div`
  ...
  @media (max-width: 768px) {
    grid-template-columns: repeat(2, minmax(120px, 1fr)); /* Ajuste para dispositivos médios */
    margin-top: 80px; /* Ajuste o espaço superior */
  }

  @media (max-width: 574px) {
    padding: 2px;
    grid-template-columns: repeat( 1, minmax(100px, 1fr)); /* Ajuste para dispositivos pequenos */
